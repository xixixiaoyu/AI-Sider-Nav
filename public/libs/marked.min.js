...
!(function (e, t) {
  ...
  function f(e, t, u) {
    ...
    t &&
      !O.test(u) &&
      ((e = u),
      g[' ' + (n = t)] || (q.test(n) ? (g[' ' + n] = n + '/') : (g[' ' + n] = C(n, '/', !0))),
      (t = -1 === (n = g[' ' + n]).indexOf(':')),
      (u =
        '//' === e.substring(0, 2)
          ? t
  ...
  function m(e, t, u, n) {
    ...
    return '!' !== e[0].charAt(0)
      ? ((n.state.inLink = !0),
        ...
        (n.state.inLink = !1),
        e)
      : { type: 'image', raw: u, href: r, title: t, text: A(i) }
  }
  var b = (function () {
      function e(e) {
      ...
      return (
        ...
        (t.heading = function (e) {
          ...
          if (e)
            return (
              (t = e[2].trim()),
              /#$/.test(t) &&
                ((u = C(t, '#')), (!this.options.pedantic && u && !/ $/.test(u)) || (t = u.trim())),
              {
                type: 'heading',
                raw: e[0],
                depth: e[1].length,
          ...
          if (e)
            return (
              ...
              this.options.sanitize &&
                ((e = this.options.sanitizer ? this.options.sanitizer(e[0]) : A(e[0])),
                (t.type = 'paragraph'),
                (t.text = e),
          ...
          if (e) {
            ...
            if (t.header.length === t.align.length) {
              ...
              for (i = t.rows.length, s = 0; s < i; s++)
                t.rows[s] = d(t.rows[s], t.header.length).map(function (e) {
                  return { text: e }
                })
        ...
        (t.escape = function (e) {
          ...
          if (e) return { type: 'escape', raw: e[0], text: A(e[1]) }
        }),
        (t.tag = function (e) {
              ...
              for (o.lastIndex = 0, t = t.slice(-1 * e.length + i); null != (n = o.exec(t)); ) {
                ...
                if (D)
                  if (((a = D.length), n[3] || n[4])) s += a
                    ...
                    return (
                      (a = Math.min(a, a + s + l)),
                      (D = e.slice(0, i + n.index + (n[0].length - D.length) + a)),
                      Math.min(i, a) % 2
                        ? ((a = D.slice(1, -1)),
                          { type: 'em', raw: D, text: a, tokens: this.lexer.inlineTokens(a) })
                        : ((a = D.slice(2, -2)),
                          { type: 'strong', raw: D, text: a, tokens: this.lexer.inlineTokens(a) })
                    )
              }
            }
          }
        ...
        (t.codespan = function (e) {
          ...
          if (e)
            return (
              ...
              (t = /[^ ]/.test(n)),
              (u = /^ /.test(n) && / $/.test(n)),
              (n = A((n = t && u ? n.substring(1, n.length - 1) : n), !0)),
        ...
        (t.autolink = function (e, t) {
          ...
          if (e)
            return (
              (t =
                '@' === e[2]
                  ? 'mailto:' + (u = A(this.options.mangle ? t(e[1]) : e[1]))
                  : (u = A(e[1]))),
              {
                type: 'link',
                raw: e[0],
              ...
              (t = this.lexer.state.inRawBlock
                ? this.options.sanitize
                  ? this.options.sanitizer
                    ...
                    : A(e[0])
                  : e[0]
                : A(this.options.smartypants ? t(e[0]) : e[0])),
  ...
  ;((w._punctuation = '!"#$%&\'()+\\-.,/:;<=>?@\\[\\]`^{|}~'),
    (w.punctuation = p(w.punctuation)
      .replace(/punctuation/g, w._punctuation)
      .getRegex()),
    (w.blockSkip = /\[[^\]]*?\]\([^\)]*?\)|`[^`]*?`|<[^>]*?>/g),
    (w.escapedEmSt = /(?:^|[^\\])(?:\\\\)*\\[*_]/g),
    (w._comment = p(B._comment).replace('(?:--\x3e|$)', '--\x3e').getRegex()),
    (w.emStrong.lDelim = p(w.emStrong.lDelim).replace(/punct/g, w._punctuation).getRegex()),
    (w.emStrong.rDelimAst = p(w.emStrong.rDelimAst, 'g')
      .replace(/punct/g, w._punctuation)
      .getRegex()),
    (w.emStrong.rDelimUnd = p(w.emStrong.rDelimUnd, 'g')
      .replace(/punct/g, w._punctuation)
      .getRegex()),
    (w._escapes = /\\([!"#$%&'()*+,\-./:;<=>?@\[\]\\^_`{|}~])/g),
    ...
    (w.autolink = p(w.autolink).replace('scheme', w._scheme).replace('email', w._email).getRegex()),
    (w._attribute = /\s+[a-zA-Z:_][\w.:-]*(?:\s*=\s*"[^"]*"|\s*=\s*'[^']*'|\s*=\s*[^\s"'=<>`]+)?/),
    (w.tag = p(w.tag).replace('comment', w._comment).replace('attribute', w._attribute).getRegex()),
    (w._label = /(?:\[(?:\\.|[^\[\]\\])*\]|\\.|`[^`]*`|[^\[\]\\`])*?/),
    (w._href = /<(?:\\.|[^\n<>\\])+>|[^\s\x00-\x1f]*/),
    (w._title = /"(?:\\"?|[^"\\])*"|'(?:\\'?|[^'\\])*'|\((?:\\\)?|[^)\\])*\)/),
    (w.link = p(w.link)
      ...
      .getRegex()),
    (w.reflink = p(w.reflink).replace('label', w._label).replace('ref', B._label).getRegex()),
    (w.nolink = p(w.nolink).replace('ref', B._label).getRegex()),
    (w.reflinkSearch = p(w.reflinkSearch, 'g')
      .replace('reflink', w.reflink)
      .replace('nolink', w.nolink)
      .getRegex()),
    (w.normal = F({}, w)),
    (w.pedantic = F({}, w.normal, {
      strong: {
        start: /^__|\*\*/,
    ...
    (w.gfm.url = p(w.gfm.url, 'i').replace('email', w.gfm._extended_email).getRegex()),
    (w.breaks = F({}, w.gfm, {
  ...
  var v = (function () {
      function u(e) {
        ...
        e = { block: B.normal, inline: w.normal }
        ;(this.options.pedantic
          ? ((e.block = B.pedantic), (e.inline = w.pedantic))
          : this.options.gfm &&
            ((e.block = B.gfm), this.options.breaks ? (e.inline = w.breaks) : (e.inline = w.gfm)),
      ...
      return (
        ...
        (n.inlineTokens = function (r, t) {
          ...
          if (this.tokens.links) {
            ...
            if (0 < D.length)
              for (; null != (n = this.tokenizer.rules.inline.reflinkSearch.exec(a)); )
          ...
          for (; null != (n = this.tokenizer.rules.inline.escapedEmSt.exec(a)); )
            ((a =
              a.slice(0, n.index + n[0].length - 2) +
              '++' +
          ...
          for (; r; )
            if (
              ...
              if ((u = this.tokenizer.escape(r))) ((r = r.substring(u.raw.length)), t.push(u))
                ...
                ((r = r.substring(u.raw.length)),
                  (e = t[t.length - 1]) && 'text' === u.type && 'text' === e.type
                    ? ((e.raw += u.raw), (e.text += u.text))
                    : t.push(u))
              else if ((u = this.tokenizer.emStrong(r, a, l)))
                ((r = r.substring(u.raw.length)), t.push(u))
              ...
              else if ((u = this.tokenizer.autolink(r, y)))
                ((r = r.substring(u.raw.length)), t.push(u))
              else if (!this.state.inLink && (u = this.tokenizer.url(r, y)))
                ((r = r.substring(u.raw.length)), t.push(u))
              else if (
                ((i = r),
                this.options.extensions &&
    ...
    S = (function () {
      ...
      return (
        (e.parse = function (e, t) {
          void 0 === t && (t = !0)
          for (
            var u, n, r, i, s, l, o, a, D, c, h, p, f, g, F, A, k = '', d = e.length, C = 0;
            C < d;
            C++
          )
            if (
              ...
              this.options.extensions &&
                ...
                (!1 !== (A = this.options.extensions.renderers[a.type].call({ parser: this }, a)) ||
                  ![
                    'space',
                    'hr',
                    'heading',
              ...
              switch (a.type) {
                ...
                case 'heading':
                  k += this.renderer.heading(
                    ...
                    a.depth,
                    x(this.parseInline(a.tokens, this.textRenderer)),
                    this.slugger
                  )
                  continue
                case 'code':
                  ...
                  continue
                case 'table':
                  for (l = D = '', r = a.header.length, u = 0; u < r; u++)
                    l += this.renderer.tablecell(this.parseInline(a.header[u].tokens), {
                      header: !0,
                      align: a.align[u],
                    })
                  for (
                    D += this.renderer.tablerow(l), o = '', r = a.rows.length, u = 0;
                    u < r;
                    u++
                  ) {
                    for (l = '', i = (s = a.rows[u]).length, n = 0; n < i; n++)
                ...
                case 'list':
                  for (
                    D = a.ordered, E = a.start, c = a.loose, r = a.items.length, o = '', u = 0;
                    u < r;
                    u++
                  )
                    ((f = (p = a.items[u]).checked),
                      (g = p.task),
                      (h = ''),
                      p.task &&
                      ...
                      (o += this.renderer.listitem(h, g, f)))
                ...
                case 'text':
                  for (
                    ...
                    C + 1 < d && 'text' === e[C + 1].type;

                  )
                    o += '\n' + ((a = e[++C]).tokens ? this.parseInline(a.tokens) : a.text)
    ...
    return function (e, u, n) {
        ...
        l =
          ...
          function (e) {
            ...
            if (((e.message += '\nPlease report this to https://github.com/markedjs/marked.'), r))
              return (
                (t = '<p>An error occurred:</p><pre>' + A(e.message + '', !0) + '</pre>'),
                i ? Promise.resolve(t) : s ? void s(null, t) : t
              )
      ...
      if (
        ...
        var D,
          c = function (t) {
            ...
            if (!t)
              try {
                ;(u.walkTokens && I.walkTokens(o, u.walkTokens),
                  (e = g(o, u)),
      ...
      if (u.async)
        return Promise.resolve(u.hooks ? u.hooks.preprocess(e) : e)
          ...
          .then(function (e) {
            return u.walkTokens
              ? Promise.all(I.walkTokens(e, u.walkTokens)).then(function () {
                  return e
                })
              : e
          })
  ...
  ;((T.passThroughHooks = new Set(['preprocess', 'postprocess'])),
    ...
    (I.use = function () {
      for (
        var D = I.defaults.extensions || { renderers: {}, childTokens: {} },
          e = arguments.length,
          t = new Array(e),
          u = 0;
        u < e;
      ...
      t.forEach(function (s) {
        var u,
          e = F({}, s)
        if (
          ((e.async = I.defaults.async || e.async || !1),
          s.extensions &&
            (s.extensions.forEach(function (r) {
              ...
              if (
                (r.renderer &&
                  ((i = D.renderers[r.name]),
                  (D.renderers[r.name] = i
                    ? function () {
                ...
                ;(D[r.level] ? D[r.level].unshift(r.tokenizer) : (D[r.level] = [r.tokenizer]),
                  r.start &&
                    ('block' === r.level
                      ? D.startBlock
                        ? D.startBlock.push(r.start)
                        : (D.startBlock = [r.start])
                      : 'inline' === r.level &&
                        (D.startInline
                          ? D.startInline.push(r.start)
                          : (D.startInline = [r.start]))))
              }
        ...
        if (s.hooks) {
          var r,
            a = I.defaults.hooks || new T()
          for (r in s.hooks)
            !(function (r) {
              var i = a[r]
              T.passThroughHooks.has(r)
                ? (a[r] = function (e) {
                    return I.defaults.async
                      ? Promise.resolve(s.hooks[r].call(a, e)).then(function (e) {
                          return i.call(a, e)
                        })
    ...
    (I.parseInline = R(v.lexInline, S.parseInline)),
    (I.Parser = S),
    (I.parser = S.parse),
    (I.Renderer = _),
    (I.TextRenderer = z),
